...
entry:
  ...
  %2 = trunc i256 %.reverse to i32
  %3 = alloca i256, align 8
  %.sub1416 = bitcast i256* %3 to i8*
  call void @ethereum.callDataCopy(i8* nonnull %.sub1416, i32 %2, i32 32)
  %4 = load i256, i256* %3, align 8
  %.reverse117 = call fastcc i256 @solidity.bswapi256(i256 %4)
  %BO_LT18 = icmp eq i256 %.reverse117, 0
  br i1 %BO_LT18, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.body
  %i.addr.020 = phi i256 [ %BO_ADD5, %for.body ], [ 0, %entry ]
  %sum.addr.019 = phi i256 [ %BO_ADD4, %for.body ], [ 0, %entry ]
  %lhs_l.i = trunc i256 %i.addr.020 to i64
  %lhs_ll.i22 = shl i64 %lhs_l.i, 5
  %o_l.i = zext i64 %lhs_ll.i22 to i256
  ...
  %BO_ADD4 = add i256 %.reverse3, %sum.addr.019
  %BO_ADD5 = add nuw i256 %i.addr.020, 1
  %9 = alloca i256, align 8
  %.sub14 = bitcast i256* %9 to i8*
  call void @ethereum.callDataCopy(i8* nonnull %.sub14, i32 %2, i32 32)
