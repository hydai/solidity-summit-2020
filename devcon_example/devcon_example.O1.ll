...
entry:
  ...
  %BO_LT5.i = icmp eq i256 %.reverse.i, 0
  br i1 %BO_LT5.i, label %array_sum.uint256.exit, label %for.body.i

for.body.i:                                       ; preds = %entry, %for.body.i
  %i.addr.07.i = phi i256 [ %BO_ADD1.i, %for.body.i ], [ 0, %entry ]
  %sum.addr.06.i = phi i256 [ %BO_ADD.i, %for.body.i ], [ 0, %entry ]
  %6 = call fastcc i256 @array_load.uint256.uint256(i256 %.reverse1, i256 %i.addr.07.i) #4
  %BO_ADD.i = add i256 %6, %sum.addr.06.i
  %BO_ADD1.i = add nuw i256 %i.addr.07.i, 1
...
array_sum.uint256.exit:                           ; preds = %for.body.i, %entry
  %sum.addr.0.lcssa.i = phi i256 [ 0, %entry ], [ %BO_ADD.i, %for.body.i ]
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %3)
  %.reverse2 = call fastcc i256 @solidity.bswapi256(i256 %sum.addr.0.lcssa.i)
