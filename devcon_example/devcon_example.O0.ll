...
define void @object.main() {
entry:
  %.reverse = call i256 @solidity.bswapi256(i256 0)
  %0 = alloca i8, i256 32
  call void @ethereum.callDataCopy(i8* %0, i32 0, i32 32)
  %1 = bitcast i8* %0 to i256*
  %2 = load i256, i256* %1
  %.reverse1 = call i256 @solidity.bswapi256(i256 %2)
  %3 = call i256 @array_sum.uint256(i256 %.reverse1)
  %.reverse2 = call i256 @solidity.bswapi256(i256 %3)
  %4 = alloca i256
  %5 = alloca i256
  store i256 %.reverse, i256* %4
  store i256 %.reverse2, i256* %5
  call void @ethereum.storageStore(i256* %4, i256* %5)
  ret void
}

define internal i256 @array_sum.uint256(i256 %x) {
entry:
  %x.addr = alloca i256
  ...
  %1 = alloca i8, i256 32
  %2 = trunc i256 %0 to i32
  call void @ethereum.callDataCopy(i8* %1, i32 %2, i32 32)
  %3 = bitcast i8* %1 to i256*
  %4 = load i256, i256* %3
  %.reverse = call i256 @solidity.bswapi256(i256 %4)
  store i256 %.reverse, i256* %length.addr
  %i.addr = alloca i256
  store i256 0, i256* %i.addr
  store i256 0, i256* %i.addr
  br label %for.cond

return:                                           ; preds = %for.end
  %5 = load i256, i256* %sum.addr
  ret i256 %5

for.cond:                                         ; preds = %for.cont, %entry
  %6 = load i256, i256* %i.addr
  %7 = load i256, i256* %length.addr
  %BO_LT = icmp ult i256 %6, %7
  br i1 %BO_LT, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %8 = load i256, i256* %sum.addr
  %9 = load i256, i256* %x.addr
  %10 = load i256, i256* %i.addr
  %11 = call i256 @array_load.uint256.uint256(i256 %9, i256 %10)
  %BO_ADD = add i256 %8, %11
  store i256 %BO_ADD, i256* %sum.addr
  br label %for.cont

for.cont:                                         ; preds = %for.body
  %12 = load i256, i256* %i.addr
  %BO_ADD1 = add i256 %12, 1
  store i256 %BO_ADD1, i256* %i.addr
  br label %for.cond
...
define internal i256 @array_load.uint256.uint256(i256 %x, i256 %i) {
entry:
  %x.addr = alloca i256
  store i256 %x, i256* %x.addr
  %i.addr = alloca i256
  store i256 %i, i256* %i.addr
  %v.addr = alloca i256
  store i256 0, i256* %v.addr
  %len.addr = alloca i256
  store i256 0, i256* %len.addr
  %0 = load i256, i256* %x.addr
  %1 = alloca i8, i256 32
  %2 = trunc i256 %0 to i32
  call void @ethereum.callDataCopy(i8* %1, i32 %2, i32 32)
  ...
  %4 = load i256, i256* %3
  %.reverse = call i256 @solidity.bswapi256(i256 %4)
  store i256 %.reverse, i256* %len.addr
  %5 = load i256, i256* %i.addr
  %6 = load i256, i256* %len.addr
  %BO_LT = icmp ult i256 %5, %6
  %7 = icmp eq i1 %BO_LT, false
  br i1 %7, label %if.then, label %if.end

return:                                           ; preds = %if.end
  %8 = load i256, i256* %v.addr
  ret i256 %8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %9 = load i256, i256* %x.addr
  %BO_ADD = add i256 %9, 32
  store i256 %BO_ADD, i256* %data.addr
  %10 = load i256, i256* %data.addr
  %11 = load i256, i256* %i.addr
  %BO_MUL3 = call i256 @__mul256(i256 %11, i256 32)
  %BO_ADD1 = add i256 %10, %BO_MUL3
  %12 = alloca i8, i256 32
  %13 = trunc i256 %BO_ADD1 to i32
  call void @ethereum.callDataCopy(i8* %12, i32 %13, i32 32)
  %14 = bitcast i8* %12 to i256*
  %15 = load i256, i256* %14
  %.reverse2 = call i256 @solidity.bswapi256(i256 %15)
  store i256 %.reverse2, i256* %v.addr
  br label %return
}

define void @main() {
entry:
  call void @object.main()
  ret void
}
