...
entry:
  ...
  store i256 %.reverse, i256* %_1.addr
  %sum.addr = alloca i256
  store i256 0, i256* %sum.addr
  store i256 0, i256* %sum.addr
  %i.addr = alloca i256
  store i256 0, i256* %i.addr
  %3 = load i256, i256* %sum.addr
  store i256 %3, i256* %i.addr
  br label %for.cond

for.cond:                                         ; preds = %for.cont, %entry
  %4 = load i256, i256* %i.addr
  %5 = load i256, i256* %_1.addr
  %6 = alloca i8, i256 32
  %7 = trunc i256 %5 to i32
  call void @ethereum.callDataCopy(i8* %6, i32 %7, i32 32)
  %8 = bitcast i8* %6 to i256*
  %9 = load i256, i256* %8
  %.reverse1 = call i256 @solidity.bswapi256(i256 %9)
  %BO_LT = icmp ult i256 %4, %.reverse1
  br i1 %BO_LT, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %10 = load i256, i256* %sum.addr
  %11 = load i256, i256* %_1.addr
  %12 = load i256, i256* %i.addr
  %BO_MUL8 = call i256 @__mul256(i256 %12, i256 32)
  %BO_ADD = add i256 %11, %BO_MUL8
  %BO_ADD2 = add i256 %BO_ADD, 32
  %13 = alloca i8, i256 32
  %14 = trunc i256 %BO_ADD2 to i32
  call void @ethereum.callDataCopy(i8* %13, i32 %14, i32 32)
  %15 = bitcast i8* %13 to i256*
  %16 = load i256, i256* %15
  %.reverse3 = call i256 @solidity.bswapi256(i256 %16)
  %BO_ADD4 = add i256 %10, %.reverse3
  store i256 %BO_ADD4, i256* %sum.addr
  br label %for.cont

for.cont:                                         ; preds = %for.body
  %17 = load i256, i256* %i.addr
  %BO_ADD5 = add i256 %17, 1
  store i256 %BO_ADD5, i256* %i.addr
  br label %for.cond

for.end:                                          ; preds = %for.cond
  %.reverse6 = call i256 @solidity.bswapi256(i256 0)
  %18 = load i256, i256* %sum.addr
  %.reverse7 = call i256 @solidity.bswapi256(i256 %18)
  %19 = alloca i256
  %20 = alloca i256
  store i256 %.reverse6, i256* %19
  store i256 %.reverse7, i256* %20
  call void @ethereum.storageStore(i256* %19, i256* %20)
  ret void
}
