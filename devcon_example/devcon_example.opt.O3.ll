; ModuleID = './devcon_example.opt.yul'
source_filename = "./devcon_example.opt.yul"
...
declare void @ethereum.storageStore(i256* readonly, i256* readonly) local_unnamed_addr #1

; Function Attrs: norecurse nounwind readnone
define internal fastcc i256 @solidity.bswapi256(i256 %data) unnamed_addr #2 {
entry:
  %0 = shl i256 %data, 248
  %1 = shl i256 %data, 232
...
; Function Attrs: nounwind
define void @object.main() local_unnamed_addr #3 {
entry:
  %0 = alloca i256, align 8
  %.sub = bitcast i256* %0 to i8*
  call void @ethereum.callDataCopy(i8* nonnull %.sub, i32 0, i32 32)
  %1 = load i256, i256* %0, align 8
  %.reverse = call fastcc i256 @solidity.bswapi256(i256 %1)
  %2 = alloca i256, align 8
  %.sub1417 = bitcast i256* %2 to i8*
  %3 = trunc i256 %.reverse to i32
  call void @ethereum.callDataCopy(i8* nonnull %.sub1417, i32 %3, i32 32)
  %4 = load i256, i256* %2, align 8
  %.reverse118 = call fastcc i256 @solidity.bswapi256(i256 %4)
  %BO_LT19 = icmp eq i256 %.reverse118, 0
  br i1 %BO_LT19, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.body
  %i.addr.021 = phi i256 [ %BO_ADD5, %for.body ], [ 0, %entry ]
  %sum.addr.020 = phi i256 [ %BO_ADD4, %for.body ], [ 0, %entry ]
  %lhs_l.i.i = trunc i256 %i.addr.021 to i64
  %lhs_ll.i.i = shl i64 %lhs_l.i.i, 5
  %o_l.i = zext i64 %lhs_ll.i.i to i256
  %BO_ADD = add i256 %.reverse, %o_l.i
  %5 = alloca i256, align 8
  %.sub15 = bitcast i256* %5 to i8*
  %6 = trunc i256 %BO_ADD to i32
  %7 = add i32 %6, 32
  call void @ethereum.callDataCopy(i8* nonnull %.sub15, i32 %7, i32 32)
  %8 = load i256, i256* %5, align 8
  %.reverse3 = call fastcc i256 @solidity.bswapi256(i256 %8)
  %BO_ADD4 = add i256 %.reverse3, %sum.addr.020
  %BO_ADD5 = add nuw i256 %i.addr.021, 1
  %9 = alloca i256, align 8
  %.sub14 = bitcast i256* %9 to i8*
  call void @ethereum.callDataCopy(i8* nonnull %.sub14, i32 %3, i32 32)
  %10 = load i256, i256* %9, align 8
  %.reverse1 = call fastcc i256 @solidity.bswapi256(i256 %10)
  %BO_LT = icmp ult i256 %BO_ADD5, %.reverse1
  br i1 %BO_LT, label %for.body, label %for.end

for.end:                                          ; preds = %for.body, %entry
  %sum.addr.0.lcssa = phi i256 [ 0, %entry ], [ %BO_ADD4, %for.body ]
  %.reverse7 = call fastcc i256 @solidity.bswapi256(i256 %sum.addr.0.lcssa)
  %11 = alloca i256, align 8
  %12 = alloca i256, align 8
  store i256 0, i256* %11, align 8
  store i256 %.reverse7, i256* %12, align 8
  call void @ethereum.storageStore(i256* nonnull %11, i256* nonnull %12)
  ret void
}
...
attributes #1 = { nounwind "wasm-import-module"="ethereum" "wasm-import-name"="storageStore" }
