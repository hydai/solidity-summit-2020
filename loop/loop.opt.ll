...
solidity.updateMemorySize.exit.i:                 ; preds = %update.i.i, %fun_F_27.exit
  ...
  br i1 %BO_GT.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %solidity.updateMemorySize.exit.i
  call void @ethereum.revert(i8* nonnull @__heap_base, i32 0) #9
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %solidity.updateMemorySize.exit.i
  ...
  %memory.size.i2.i = load i256, i256* @memory.size, align 256
  %25 = icmp ult i256 %memory.size.i2.i, 96
  br i1 %25, label %update.i3.i, label %allocateMemory.uint256.exit

update.i3.i:                                      ; preds = %if.end.i
  store i256 128, i256* @memory.size, align 256
  br label %allocateMemory.uint256.exit

allocateMemory.uint256.exit:                      ; preds = %if.end.i, %update.i3.i
  %26 = trunc i256 %.reverse.i to i32
  %heap.cptr = getelementptr inbounds i8, i8* @__heap_base, i32 %26
  %memory.size.i9 = load i256, i256* @memory.size, align 256
  %27 = icmp ugt i256 %.reverse.i, %memory.size.i9
  br i1 %27, label %update.i10, label %solidity.updateMemorySize.exit11

update.i10:                                       ; preds = %allocateMemory.uint256.exit
  %28 = add i256 %.reverse.i, 32
  %memory.new_size.i = and i256 %28, -32
...
solidity.updateMemorySize.exit11:                 ; preds = %allocateMemory.uint256.exit, %update.i10
  call void @ethereum.finish(i8* nonnull %heap.cptr, i32 0)
  br label %if.end
}
