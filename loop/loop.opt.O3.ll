...
entry:
  ...
  %4 = icmp ult i256 %memory.size.i, 96
  br i1 %4, label %update.i, label %solidity.updateMemorySize.exit
...
if.end:                                           ; preds = %solidity.updateMemorySize.exit11, %if.then, %solidity.updateMemorySize.exit
...
if.end3:                                          ; preds = %switch.case, %if.then2
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %15) #9
  store i256 452312848583266388373324160190187140051835877600158453279131187530910662656, i256* %0, align 8
  call void @ethereum.storageLoad(i256* nonnull %0, i256* nonnull %1) #9
  store i256 452312848583266388373324160190187140051835877600158453279131187530910662656, i256* %2, align 8
  store i256 452312848583266388373324160190187140051835877600158453279131187530910662656, i256* %3, align 8
  call void @ethereum.storageStore(i256* nonnull %2, i256* nonnull %3) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %12) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %13) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %14) #9
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %15) #9
  store i256 904625697166532776746648320380374280103671755200316906558262375061821325312, i256* %0, align 8
  call void @ethereum.storageLoad(i256* nonnull %0, i256* nonnull %1) #9
  store i256 904625697166532776746648320380374280103671755200316906558262375061821325312, i256* %2, align 8
  store i256 904625697166532776746648320380374280103671755200316906558262375061821325312, i256* %3, align 8
  call void @ethereum.storageStore(i256* nonnull %2, i256* nonnull %3) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %12) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %13) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %14) #9
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %15) #9
  store i256 1356938545749799165119972480570561420155507632800475359837393562592731987968, i256* %0, align 8
  call void @ethereum.storageLoad(i256* nonnull %0, i256* nonnull %1) #9
  store i256 1356938545749799165119972480570561420155507632800475359837393562592731987968, i256* %2, align 8
  store i256 1356938545749799165119972480570561420155507632800475359837393562592731987968, i256* %3, align 8
  call void @ethereum.storageStore(i256* nonnull %2, i256* nonnull %3) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %12) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %13) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %14) #9
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %15) #9
  store i256 1809251394333065553493296640760748560207343510400633813116524750123642650624, i256* %0, align 8
  call void @ethereum.storageLoad(i256* nonnull %0, i256* nonnull %1) #9
  store i256 1809251394333065553493296640760748560207343510400633813116524750123642650624, i256* %2, align 8
  store i256 1809251394333065553493296640760748560207343510400633813116524750123642650624, i256* %3, align 8
  call void @ethereum.storageStore(i256* nonnull %2, i256* nonnull %3) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %12) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %13) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %14) #9
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %15) #9
  store i256 2261564242916331941866620800950935700259179388000792266395655937654553313280, i256* %0, align 8
  call void @ethereum.storageLoad(i256* nonnull %0, i256* nonnull %1) #9
  store i256 2261564242916331941866620800950935700259179388000792266395655937654553313280, i256* %2, align 8
  store i256 2261564242916331941866620800950935700259179388000792266395655937654553313280, i256* %3, align 8
  call void @ethereum.storageStore(i256* nonnull %2, i256* nonnull %3) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %12) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %13) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %14) #9
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %15) #9
  store i256 2713877091499598330239944961141122840311015265600950719674787125185463975936, i256* %0, align 8
  call void @ethereum.storageLoad(i256* nonnull %0, i256* nonnull %1) #9
  store i256 2713877091499598330239944961141122840311015265600950719674787125185463975936, i256* %2, align 8
  store i256 2713877091499598330239944961141122840311015265600950719674787125185463975936, i256* %3, align 8
  call void @ethereum.storageStore(i256* nonnull %2, i256* nonnull %3) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %12) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %13) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %14) #9
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %15) #9
  store i256 3166189940082864718613269121331309980362851143201109172953918312716374638592, i256* %0, align 8
  call void @ethereum.storageLoad(i256* nonnull %0, i256* nonnull %1) #9
  store i256 3166189940082864718613269121331309980362851143201109172953918312716374638592, i256* %2, align 8
  store i256 3166189940082864718613269121331309980362851143201109172953918312716374638592, i256* %3, align 8
  call void @ethereum.storageStore(i256* nonnull %2, i256* nonnull %3) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %12) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %13) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %14) #9
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %15) #9
  store i256 3618502788666131106986593281521497120414687020801267626233049500247285301248, i256* %0, align 8
  call void @ethereum.storageLoad(i256* nonnull %0, i256* nonnull %1) #9
  store i256 3618502788666131106986593281521497120414687020801267626233049500247285301248, i256* %2, align 8
  store i256 3618502788666131106986593281521497120414687020801267626233049500247285301248, i256* %3, align 8
  call void @ethereum.storageStore(i256* nonnull %2, i256* nonnull %3) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %12) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %13) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %14) #9
  ...
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %15) #9
  store i256 4070815637249397495359917441711684260466522898401426079512180687778195963904, i256* %0, align 8
  call void @ethereum.storageLoad(i256* nonnull %0, i256* nonnull %1) #9
  store i256 4070815637249397495359917441711684260466522898401426079512180687778195963904, i256* %2, align 8
  store i256 4070815637249397495359917441711684260466522898401426079512180687778195963904, i256* %3, align 8
  call void @ethereum.storageStore(i256* nonnull %2, i256* nonnull %3) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %12) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %13) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %14) #9
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %15) #9
  %16 = load i256, i256* bitcast (i8* getelementptr (i8, i8* @__heap_base, i32 64) to i256*), align 8
  %.reverse.i = call fastcc i256 @solidity.bswapi256(i256 %16) #9
  %memory.size.i.i = load i256, i256* @memory.size, align 256
  %17 = icmp ult i256 %memory.size.i.i, 96
  br i1 %17, label %update.i.i, label %solidity.updateMemorySize.exit.i
...
solidity.updateMemorySize.exit.i:                 ; preds = %update.i.i, %if.end3
  %memory.size.i913 = phi i256 [ 128, %update.i.i ], [ %memory.size.i.i, %if.end3 ]
...
if.end.i:                                         ; preds = %solidity.updateMemorySize.exit.i
  ...
  %18 = icmp ult i256 %memory.size.i2.pre.i, 96
  br i1 %18, label %allocateMemory.uint256.exit.thread, label %allocateMemory.uint256.exit

allocateMemory.uint256.exit.thread:               ; preds = %if.end.i
  store i256 128, i256* @memory.size, align 256
  %19 = trunc i256 %.reverse.i to i32
  %heap.cptr15 = getelementptr inbounds i8, i8* @__heap_base, i32 %19
  br label %update.i10

allocateMemory.uint256.exit:                      ; preds = %if.end.thread.i, %if.end.i
  %memory.size.i9 = phi i256 [ %memory.size.i913, %if.end.thread.i ], [ %memory.size.i2.pre.i, %if.end.i ]
  %20 = trunc i256 %.reverse.i to i32
  %heap.cptr = getelementptr inbounds i8, i8* @__heap_base, i32 %20
  %21 = icmp ugt i256 %.reverse.i, %memory.size.i9
  br i1 %21, label %update.i10, label %solidity.updateMemorySize.exit11

update.i10:                                       ; preds = %allocateMemory.uint256.exit.thread, %allocateMemory.uint256.exit
  %heap.cptr17 = phi i8* [ %heap.cptr15, %allocateMemory.uint256.exit.thread ], [ %heap.cptr, %allocateMemory.uint256.exit ]
  %22 = add i256 %.reverse.i, 32
  %memory.new_size.i = and i256 %22, -32
  store i256 %memory.new_size.i, i256* @memory.size, align 256
  br label %solidity.updateMemorySize.exit11

solidity.updateMemorySize.exit11:                 ; preds = %allocateMemory.uint256.exit, %update.i10
  %heap.cptr16 = phi i8* [ %heap.cptr, %allocateMemory.uint256.exit ], [ %heap.cptr17, %update.i10 ]
  call void @ethereum.finish(i8* nonnull %heap.cptr16, i32 0)
  br label %if.end
}
