object "C_28" {
    code {
        ...
        codecopy(0, dataoffset("C_28_deployed"), datasize("C_28_deployed"))
        return(0, datasize("C_28_deployed"))
        ...
        function storage_array_index_access_t_array$_t_uint256_$10_storage(array, index) -> slot, offset {
            if iszero(lt(index, array_length_t_array$_t_uint256_$10_storage(array))) {
                invalid()
            }
...
object "C_28" {
    code {
        ...
        function storage_array_index_access_t_array$_t_uint256_$10_storage(array, index) -> slot, offset
        {
            if iszero(lt(index, array_length_t_array$_t_uint256_$10_storage(array))) { invalid() }
            let data := array_dataslot_t_array$_t_uint256_$10_storage(array)
            slot := add(data, mul(index, 1))
            offset := 0
        }
